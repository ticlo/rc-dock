...
class DividerBox extends react_1.default.PureComponent {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", Object.assign({ ref: this.getRef, className: classnames_1.default(cls, this.context.getClassName()) }, others), childrenRender));
    }
}
