...
},{"./bundle-url":"CSru"}],"hnNz":[function(require,module,exports) {
require("_bundle_loader")(require.resolve('./shared-import')).then(({
  ...
  let defaultTab = {
    title: 'default-style',
    content: /*#__PURE__*/React.createElement("div", null, "Tabs from different style group can't be docked in same panel")
  };
  let headlessTab = {
    title: 'headless',
