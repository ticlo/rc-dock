...
class WindowBox extends React.PureComponent {
    render() {
        ...
        for (let child of children) {
            if ('tabs' in child) {
                childrenRender.push(React.createElement(WindowPanel_1.WindowPanel, { key: child.id, panelData: child, onWindowOpened: onWindowOpened, onWindowClosing: onWindowClosing }));
            }
        }
