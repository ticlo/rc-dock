...
class DndDragDropDiv extends react_1.default.PureComponent {
    ...
    render() {
        ...
        // item types props
        sourceItemType, targetItemType } = _a, others = __rest(_a, ["getRef", "children", "className", "directDragT", "onDragStartT", "onDragMoveT", "onDragEndT", "onDragOverT", "onDragLeaveT", "onDropT", "onGestureStartT", "onGestureMoveT", "onGestureEndT", "useRightButtonDragT", "extraData", "isDragging", "connectDragSource", "isOver", "canDrop", "connectDropTarget", "isOverCurrent", "itemType", "sourceItemType", "targetItemType"]);
    ...
    hover(props, monitor, component) {
        ...
        if (!tab && monitor.getItem().externalData) {
            const tab = monitor.getItem().externalData.tab.id ?
                monitor.getItem().externalData.tab : Object.assign({ id: uuid_1.v4() }, monitor.getItem().externalData.tab);
            state.setData({
                tab,
                panelSize: [400, 300]
            }, dockId);
...
const dragSpec = {
    ...
    endDrag(props, monitor, component) {
        var _a, _b, _c, _d, _e, _f;
        const state = monitor.didDrop() && ((_a = monitor.getDropResult()) === null || _a === void 0 ? void 0 : _a.state) ?
        ...
        if ((_b = monitor.getDropResult()) === null || _b === void 0 ? void 0 : _b.dropOutside) {
            const externalDockId = (_e = (_d = (_c = monitor.getItem()) === null || _c === void 0 ? void 0 : _c.externalData) === null || _d === void 0 ? void 0 : _d.context) === null || _e === void 0 ? void 0 : _e.getDockId();
            if (externalDockId) {
                const tab = (_f = monitor.getItem()) === null || _f === void 0 ? void 0 : _f.externalData.tab;
                externalDockId.dockMove(tab, null, 'remove');
            }
        }
        DragManager_1.dragEnd();
...
const withDefaultItemTypes = (WrappedComponent) => {
    return (props) => {
        // @ts-ignore
        const { props: { defaultSourceItemType, defaultTargetItemType } } = react_1.useContext(DockData_1.DockContextType);
        const sourceItemType = react_1.useMemo(() => defaultSourceItemType, []);
        const targetItemType = react_1.useMemo(() => defaultTargetItemType, []);
        return (react_1.default.createElement(WrappedComponent, Object.assign({}, props, { sourceItemType: sourceItemType, targetItemType: targetItemType })));
    };
};
const EnhancedDndDragDropDiv = withDefaultItemTypes(lodash_1.default.flow(react_dnd_1.DragSource(({ sourceItemType }) => sourceItemType !== undefined ? sourceItemType : Constants_1.ITEM_TYPE_DEFAULT, dragSpec, dragCollect), react_dnd_1.DropTarget(({ targetItemType }) => targetItemType !== undefined ? targetItemType : Constants_1.ITEM_TYPE_DEFAULT, dropSpec, dropCollect))(DndDragDropDiv));
