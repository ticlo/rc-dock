...
class DragDropDiv extends react_1.default.Component {
    ...
    render() {
        let _a = this.props, { getRef, children, onDragStartT, onDragMoveT, onDragEndT, onDragOverT, onDragLeaveT, onDropT, className } = _a, others = __rest(_a, ["getRef", "children", "onDragStartT", "onDragMoveT", "onDragEndT", "onDragOverT", "onDragLeaveT", "onDropT", "className"]);
        ...
        return (react_1.default.createElement("div", Object.assign({ ref: this._getRef, className: className }, others, { onPointerDown: this.onPointerDown }), children));
    }
