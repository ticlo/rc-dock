...
class DockDropSquare extends react_1.default.PureComponent {
    ...
    render() {
        ...
        return (react_1.default.createElement(DragDropDiv_1.DragDropDiv, { className: classes.join(' '), onDragOverT: this.onDragOver, onDragLeaveT: this.onDragLeave, onDropT: this.onDrop },
            react_1.default.createElement("div", { className: classnames_1.default("dock-drop-square-box", this.context.getClassName()) })));
    }
...
class DockDropLayer extends react_1.default.PureComponent {
    ...
    render() {
        ...
        let draggingTab = DragManager_1.DragState.getData('tab', dockId);
        let fromPanelGroup = Utils_1.mergeTabGroups(this.context.getGroup(dropFromPanel.group), dropFromPanel.localGroup);
        let fromTabGroup = Utils_1.mergeTabGroups(this.context.getGroup(draggingTab === null || draggingTab === void 0 ? void 0 : draggingTab.group), draggingTab === null || draggingTab === void 0 ? void 0 : draggingTab.localGroup);
        ...
        return (react_1.default.createElement("div", { className: classnames_1.default("dock-drop-layer", this.context.getClassName()), style: {
