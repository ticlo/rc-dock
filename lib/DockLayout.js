...
class DockLayout extends DockPortalManager {
    ...
    render() {
        ...
        if (maximizeTo) {
            ...
            maximize = react_dom_1.default.createPortal(React.createElement(MaxBox_1.MaxBox, { boxData: layout.maxbox }), maximizeTo);
        }
        else {
            maximize = React.createElement(MaxBox_1.MaxBox, { boxData: layout.maxbox });
        }
        // }
        let portals = [];
        ...
        return (React.createElement(react_dnd_1.DndProvider, { backend: react_dnd_html5_backend_1.HTML5Backend },
            React.createElement("div", { ref: this.getRef, className: classnames_1.default("dock-layout", className, {
                ...
                React.createElement(DockData_1.DockContextProvider, { value: this },
                    React.createElement(DockBox_1.DockBox, { size: 1, boxData: layout.dockbox }),
                    React.createElement(FloatBox_1.FloatBox, { boxData: layout.floatbox }),
                    React.createElement(WindowBox_1.WindowBox, { boxData: layout.windowbox }),
                    maximize,
                    portals),
                React.createElement("div", { className: classnames_1.default("dock-drop-indicator", {
