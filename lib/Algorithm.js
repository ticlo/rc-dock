...
exports.getPanelTabPosition = exports.findNearestPanel = exports.getFloatPanelSize = exports.replacePanel = exports.fixLayoutData = exports.updatePanelLocalGroup = exports.fixFloatPanelPos = exports.maximize = exports.moveToFront = exports.calculateBoxPreferredSize = exports.removeFromLayout = exports.panelToWindow = exports.floatPanel = exports.dockPanelToBox = exports.dockPanelToPanel = exports.converToPanel = exports.addTabToPanel = exports.addNextToTab = exports.find = exports.Filter = exports.nextZIndex = exports.nextId = exports.getUpdatedObject = void 0;
...
function calculateBoxPreferredSize(box) {
    let preferredWidth;
    let preferredHeight;
...
exports.calculateBoxPreferredSize = calculateBoxPreferredSize;
...
function fixFloatPanelPos(layout, layoutWidth, layoutHeight, floatingTopCheckDisabled) {
...
function updatePanelLocalGroup(panel, layout) {
...
exports.updatePanelLocalGroup = updatePanelLocalGroup;
function fixLayoutData(layout, groups, loadTab) {
    ...
    function fixPanelData(panel) {
        ...
        panel.collapsed = (_c = (_b = panel.tabs[0]) === null || _b === void 0 ? void 0 : _b.collapsed) !== null && _c !== void 0 ? _c : panel.collapsed;
        updatePanelLocalGroup(panel, layout);
        let tabGroup = Utils_1.mergeTabGroups(groups === null || groups === void 0 ? void 0 : groups[panel.group], panel.localGroup);
        if (tabGroup) {
    ...
    const hasFloatRefs = (node) => { var _a; return !!((_a = layout.floatbox) === null || _a === void 0 ? void 0 : _a.children.find((floatedChild) => { var _a, _b; return ((_b = (_a = floatedChild.dockLocation) === null || _a === void 0 ? void 0 : _a.parent) === null || _b === void 0 ? void 0 : _b.id) === node.id; })); };
    ...
    if (layout.dockbox.children.length === 0) {
        ...
        let newPanel = { id: '+0', group: DockData_1.placeHolderStyle, panelLock: {}, size: PANEL_SIZE_DEFAULT, tabs: [] };
...
function getPanelTabPosition(panelData) {
    var _a, _b;
    if (!panelData.collapsed) {
        return panelData.tabPosition;
    }
    if (((_a = panelData.parent) === null || _a === void 0 ? void 0 : _a.mode) === "horizontal") {
    ...
    if (((_b = panelData.parent) === null || _b === void 0 ? void 0 : _b.mode) === "vertical") {
...
exports.getPanelTabPosition = getPanelTabPosition;
