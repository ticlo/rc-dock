...
class DockPanel extends react_1.default.PureComponent {
    ...
    render() {
        ...
        return (react_1.default.createElement(DragDropDiv_1.DragDropDiv, { getRef: this.getRef, className: classnames_1.default(cls, {
            ...
            isFloat ?
                [
                    react_1.default.createElement(DragDropDiv_1.DragDropDiv, { key: "drag-size-t", className: classnames_1.default("dock-panel-drag-size", {
                    ...
                    react_1.default.createElement(DragDropDiv_1.DragDropDiv, { key: "drag-size-b", className: classnames_1.default("dock-panel-drag-size", {
                    ...
                    react_1.default.createElement(DragDropDiv_1.DragDropDiv, { key: "drag-size-l", className: classnames_1.default("dock-panel-drag-size", {
                    ...
                    react_1.default.createElement(DragDropDiv_1.DragDropDiv, { key: "drag-size-r", className: classnames_1.default("dock-panel-drag-size", {
                    ...
                    react_1.default.createElement(DragDropDiv_1.DragDropDiv, { key: "drag-size-t-l", className: classnames_1.default("dock-panel-drag-size", {
                    ...
                    react_1.default.createElement(DragDropDiv_1.DragDropDiv, { key: "drag-size-t-r", className: classnames_1.default("dock-panel-drag-size", {
                    ...
                    react_1.default.createElement(DragDropDiv_1.DragDropDiv, { key: "drag-size-b-l", className: classnames_1.default("dock-panel-drag-size", {
                    ...
                    react_1.default.createElement(DragDropDiv_1.DragDropDiv, { key: "drag-size-b-r", className: classnames_1.default("dock-panel-drag-size", {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        const { panelData } = this.props;
        if (panelData.headerSize === undefined || Algorithm_1.getPanelTabPosition(prevProps.panelData) !== Algorithm_1.getPanelTabPosition(this.props.panelData)) {
            this.updatePanelData();
        }
    }
    updatePanelData() {
