...
class DockBox extends react_1.default.PureComponent {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", { ref: this.getRef, className: classnames_1.default(cls, this.context.getClassName()), "data-dockid": id, style: style }, childrenRender));
    }
}
