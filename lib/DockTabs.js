...
class TabCache {
    ...
    render() {
        ...
        let tab = (react_1.default.createElement(DragDropDiv_1.DragDropDiv, { getRef: this.getRef, onDragStartT: onDragStart, role: "tab", "aria-selected": parent.activeId === id, onDragOverT: onDragOver, onDropT: onDrop, onDragLeaveT: onDragLeave, extraData: this.data },
            title,
            closable ?
...
class DockTabs extends react_1.default.PureComponent {
    ...
    render() {
        ...
        return (react_1.default.createElement(rc_tabs_1.default, { prefixCls: "dock", moreIcon: "...", animated: animated, renderTabBar: this.renderTabBar, activeKey: activeId, tabPosition: tabPosition, onChange: this.onTabChange }, children));
    }
}
