...
class DockTabs extends react_1.default.PureComponent {
    constructor() {
        ...
        this.renderTabBar = (props, DefaultTabBar) => {
            ...
            if (panelExtra) {
                ...
                if (group.newWindow && WindowBox_1.WindowBox.enabled && panelData.parent.mode === 'float') {
    ...
    addNewWindowMenu(element) {
        ...
        return (react_1.default.createElement(rc_dropdown_1.default, { prefixCls: "dock-dropdown", overlay: nativeMenu, trigger: ['contextMenu'], mouseEnterDelay: 0.1, mouseLeaveDelay: 0.1 }, element));
    }
    render() {
