...
class DockTabBarRootNode extends react_1.default.PureComponent {
    render() {
        ...
        return (react_1.default.createElement(DragDropDiv_1.DragDropDiv, { onDragInit: onDragMoveInit, onDragStart: onHtmlDrag, draggable: onHtmlDrag != null, role: "tablist", className: 'dock-bar', tabIndex: 0, ref: this.props.saveRef('root'), onKeyDown: onKeyDown, style: style }, newChildren));
    }
}
