...
(async function () {
  ...
  class Demo extends React.Component {
    ...
    render() {
      ...
      return React.createElement("div", null, "Divider can be used separately, this doesn't require anything else from the dock layout package", React.createElement("div", {
        ref: this.getRef,
        className: "box"
