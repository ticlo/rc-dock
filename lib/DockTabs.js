...
class TabCache {
    ...
    render() {
        ...
        if (cacheContext) {
            ...
            return (react_1.default.createElement(Consumer, null, (value) => (react_1.default.createElement(DockTabPane_1.default, { key: id, id: id, cached: cached, tab: tab, contextValue: value, contextType: cacheContext }, content))));
        }
        else {
