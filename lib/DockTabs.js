    ...
    constructor() {
        ...
        this.renderTabBar = (props, DefaultTabBar) => {
            ...
            if (panelExtra) {
                ...
                panelExtraContent = (react_1.default.createElement(rc_dropdown_1.default, { prefixCls: "dock-dropdown", overlay: nativeMenu, trigger: ['contextMenu'], mouseEnterDelay: 0.1, mouseLeaveDelay: 0.1 },
                    react_1.default.createElement("div", { className: 'dock-panel-max-btn', onClick: this.onMaximizeClick, onKeyDown: this.onKeyDownMaximizeBtn, tabIndex: 0 })));
            }
            return (react_1.default.createElement(DockTabBar_1.DockTabBar, Object.assign({ onDragStart: onPanelDragStart, onDragMove: onPanelDragMove, onDragEnd: onPanelDragEnd }, props, { extra: panelExtraContent })));
        };
