...
export class DockTabBarRootNode extends React.PureComponent {
    render() {
        const _a = this.props, { onKeyDown, extraContent, style, children, onDragInit } = _a, restProps = __rest(_a, ["onKeyDown", "extraContent", "style", "children", "onDragInit"]);
        ...
        return (React.createElement(DragInitiator, { onDragInit: onDragInit, role: "tablist", className: 'dock-tabs-bar', tabIndex: 0, ref: this.props.saveRef('root'), onKeyDown: onKeyDown, style: style }, newChildren));
    }
}
export class DockTabBar extends React.PureComponent {
    render() {
        const _a = this.props, { children: renderTabBarNode, onDragInit } = _a, restProps = __rest(_a, ["children", "onDragInit"]);
        return (React.createElement(SaveRef, null, (saveRef, getRef) => (React.createElement(DockTabBarRootNode, Object.assign({ saveRef: saveRef, onDragInit: onDragInit }, restProps),
