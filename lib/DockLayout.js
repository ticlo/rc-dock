...
class DockLayout extends DockPortalManager {
    ...
    updatePanelLocalGroup(panel) {
        Algorithm_1.updatePanelLocalGroup(panel, this.getLayout());
    }
    /** @ignore */
    getLayoutSize() {
        if (this._ref) {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", { ref: this.getRef, className: classnames_1.default("dock-layout", className, {
            ...
            react_1.default.createElement(DockData_1.DockContextProvider, { value: this },
                ...
                maximize,
                portals),
            react_1.default.createElement("div", { className: classnames_1.default("dock-drop-indicator", {
