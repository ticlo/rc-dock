...
},{"./bundle-url":"FheM"}],"Pjdl":[function(require,module,exports) {
...
require("_bundle_loader")(require.resolve('./shared-import')).then(({
  ...
  function getTab(id, value) {
    return {
      id,
      content: /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "It's easier to use React Context to update tab,", /*#__PURE__*/React.createElement("br", null), "but in some use cases you might need to directly update the tab."), id !== `tab${value}` ? /*#__PURE__*/React.createElement("p", null, "Only current active tab will be changed") : null, "value is ", value),
      title: id,
      group: 'locked'
    };
  }
