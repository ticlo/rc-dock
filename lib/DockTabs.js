...
export class TabCache {
    ...
    render() {
        ...
        return (React.createElement(DockTabPane, { key: id, id: id, cached: cached, tab: React.createElement("div", { ref: this.getRef },
                title,
                React.createElement("div", { className: 'dock-tabs-tab-hit-area', ref: this.getHitAreaRef, draggable: !tabLocked, onDrag: this.onDragStart, onDragOver: this.onDragOver, onDrop: this.onDrop, onDragLeave: this.onDragLeave }, closable ?
