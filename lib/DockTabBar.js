...
const DragInitiator_1 = require("./dragdrop/DragInitiator");
class DockTabBarRootNode extends react_1.default.PureComponent {
    render() {
        ...
        return (react_1.default.createElement(DragInitiator_1.DragInitiator, { onDragInit: onDragMoveInit, onDragStart: onHtmlDrag, draggable: onHtmlDrag != null, role: "tablist", className: 'dock-bar', tabIndex: 0, ref: this.props.saveRef('root'), onKeyDown: onKeyDown, style: style }, newChildren));
    }
}
class DockTabBar extends react_1.default.PureComponent {
    render() {
        const _a = this.props, { children: renderTabBarNode, onDragMoveInit, onHtmlDrag, extraContent } = _a, restProps = __rest(_a, ["children", "onDragMoveInit", "onHtmlDrag", "extraContent"]);
        return (react_1.default.createElement(SaveRef_1.default, null, (saveRef, getRef) => (react_1.default.createElement(DockTabBarRootNode, Object.assign({ saveRef: saveRef, onDragMoveInit: onDragMoveInit, onHtmlDrag: onHtmlDrag, extraContent: extraContent }, restProps),
