...
export class TabCache {
    ...
    render() {
        ...
        return (React.createElement(DockTabPane, { key: id, tab: React.createElement("div", { ref: this.getRef, draggable: !tabLocked, onDrag: this.onDragStart, onDragOver: this.onDragOver, onDrop: this.onDrop, onDragLeave: this.onDragLeave },
