...
class TabCache {
    constructor(context) {
        ...
        this.onDragStart = (e) => {
            DragStore_1.DragStore.dragStart(this.context, { tab: this.data }, this._ref);
        };
        this.onDragOver = (e) => {
            let tab = DragStore_1.DragStore.getData(this.context, 'tab');
    ...
    render() {
        ...
        return (react_1.default.createElement(rc_tabs_1.TabPane, { key: id, tab: react_1.default.createElement("span", { ref: this.getRef, draggable: !tabLocked, onDrag: this.onDragStart, onDragOver: this.onDragOver, onDrop: this.onDrop },
                title,
                closable ?
