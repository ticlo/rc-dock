...
exports.DragState = exports.removeBodyDraggingClass = exports.addBodyDraggingClass = exports.getTabByDockId = exports.dragEnd = exports.removeDragStateListener = exports.addDragStateListener = exports.removeHandlers = exports.addHandlers = exports.isDragging = void 0;
class RcDragState {
...
exports.getTabByDockId = getTabByDockId;
function addBodyDraggingClass() {
    document.body.classList.add('dock-dragging');
}
exports.addBodyDraggingClass = addBodyDraggingClass;
function removeBodyDraggingClass() {
    document.body.classList.remove('dock-dragging');
}
exports.removeBodyDraggingClass = removeBodyDraggingClass;
const DragStateImpl = DndDragState;
class DragState extends DragStateImpl {
}
