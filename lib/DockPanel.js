...
class DockPanel extends react_1.default.PureComponent {
    ...
    render() {
        ...
        let droppingLayer;
        if (dropGroup) {
            droppingLayer = react_1.default.createElement(DockDropLayer_1.DockDropLayer, { panelData: panelData, panelElement: this._ref, dropGroup: dropGroup });
        }
