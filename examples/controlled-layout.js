...
require("_bundle_loader")(require.resolve('./shared-import')).then(({
  ...
  let tab0 = {
    ...
    content: /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "When you use ", /*#__PURE__*/React.createElement("b", null, "layout"), " instead of ", /*#__PURE__*/React.createElement("b", null, "defaultLayout"), " on <DockLayout>"), /*#__PURE__*/React.createElement("p", null, "DockLayout will work as a controlled component"))
  };
  let box = {
    dockbox: {
      mode: 'horizontal',
