...
},{"./bundle-url":"CSru"}],"THgn":[function(require,module,exports) {
require("_bundle_loader")(require.resolve('./shared-import')).then(({
    ...
    dockbox: {
      ...
      children: [{
        tabs: [{
          id: 't1',
          title: 'Tool',
          content: /*#__PURE__*/React.createElement("div", null, "Left Side Dock Layout")
        }]
      }, {
        tabs: [{
          id: 't2',
    ...
    dockbox: {
      ...
      children: [{
        tabs: [{
          id: 't3',
          title: 'Dock',
          content: /*#__PURE__*/React.createElement("div", null, "Right Side Dock Layout.")
        }, jsxTab, htmlTab]
      }]
    }
  };
  ...
  class Demo extends React.Component {
    render() {
      return /*#__PURE__*/React.createElement(DividerBox, {
        style: {
          position: 'absolute',
          left: 10,
          top: 10,
      ...
      }), /*#__PURE__*/React.createElement(DividerBox, {
        mode: "vertical",
        style: {
          width: '20%',
          minWidth: 100
      ...
      }, "not DockLayout, only DividerBox"), /*#__PURE__*/React.createElement("div", {
        style: {
          border: '1px solid #ccc'
        }
      }, "You can use DividerBox for fixed Tool Panels")), /*#__PURE__*/React.createElement(DockLayout, {
