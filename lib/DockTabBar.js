...
class DockTabBarRootNode extends react_1.default.PureComponent {
    render() {
        const _a = this.props, { onKeyDown, extraContent, style, children, onDragStart, onDragMove, onDragEnd } = _a, restProps = __rest(_a, ["onKeyDown", "extraContent", "style", "children", "onDragStart", "onDragMove", "onDragEnd"]);
...
class DockTabBar extends react_1.default.PureComponent {
    render() {
        const _a = this.props, { children: renderTabBarNode, onDragStart, onDragMove, onDragEnd, extraContent } = _a, restProps = __rest(_a, ["children", "onDragStart", "onDragMove", "onDragEnd", "extraContent"]);
