...
class DockTabPane extends react_1.default.PureComponent {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", { ref: getRef, id: cacheId, "data-tab-id": `dock-${cacheId}`, role: "tabpanel", "aria-labelledby": id && `${id}-tab-${tabKey}`, "aria-hidden": !active, style: Object.assign(Object.assign({}, mergedStyle), style), className: classnames_1.default(`${prefixCls}-tabpane`, active && `${prefixCls}-tabpane-active`, className, this.context.getClassName()) }, (active || this.visited || forceRender) && renderChildren));
    }
    componentDidMount() {
        var _a, _b;
        (_b = (_a = this.props).onTabActiveChange) === null || _b === void 0 ? void 0 : _b.call(_a, !!this.props.active);
        this.updateCache();
    }
