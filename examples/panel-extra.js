...
},{"./bundle-url":"CSru"}],"fRmv":[function(require,module,exports) {
require("_bundle_loader")(require.resolve('./shared-import')).then(({
  ...
  let tab = {
    title: 'Tab',
    content: /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "Custom component can be added to panel's title bar."), /*#__PURE__*/React.createElement("p", null, "This panel has a custom maximize button and a close all button")),
    group: 'close-all'
  };
  let count = 0;
  ...
  function newTab() {
    return {
      id: `newtab${++count}`,
      title: 'New Tab',
      content: /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "This panel has an 'add' button defined in panelLock"))
    };
  }
    ...
    dockbox: {
      ...
      children: [{
        ...
        children: [{
          ...
          panelLock: {
            minWidth: 200,
            panelExtra: (panelData, context) => /*#__PURE__*/React.createElement("button", {
              className: "btn",
