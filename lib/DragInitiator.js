...
export class DragInitiator extends React.Component {
    constructor() {
        super(...arguments);
        this.dragging = false;
        this.isTouch = false;
    ...
    render() {
        ...
        return (React.createElement("div", Object.assign({ ref: getRef }, others, { onPointerDown: this.onPointerDown }), children));
    }
