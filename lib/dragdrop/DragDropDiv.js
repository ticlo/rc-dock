...
class DndDragDropDiv extends react_1.default.PureComponent {
    ...
    render() {
        ...
        return (connectDragSource(connectDropTarget(react_1.default.createElement("div", Object.assign({ ref: this._getRef, className: classnames_1.default("react-dnd", "dnd-wrapper", className, this.context.getClassName()) }, others), children))));
    }
}
...
function canDrag(props) {
    ...
    if (props.role === "resizer") {
        let panelGroup = Utils_1.mergeTabGroups(props.dockContext.getGroup((_a = props.panelData) === null || _a === void 0 ? void 0 : _a.group), (_b = props.panelData) === null || _b === void 0 ? void 0 : _b.localGroup);
    ...
    if (props.role === "tablist") {
        let panelGroup = Utils_1.mergeTabGroups(props.dockContext.getGroup((_e = props.panelData) === null || _e === void 0 ? void 0 : _e.group), (_f = props.panelData) === null || _f === void 0 ? void 0 : _f.localGroup);
...
const dragSpec = {
    ...
    beginDrag(props, monitor, component) {
        var _a, _b, _c, _d;
        DragManager_1.addBodyDraggingClass();
    ...
    endDrag(props, monitor, component) {
        ...
        DragManager_1.removeBodyDraggingClass();
...
const withDockContext = (WrappedComponent) => {
    return (props) => {
        ...
        return (react_1.default.createElement(WrappedComponent, Object.assign({ dockContext: context }, props)));
    };
};
const EnhancedDndDragDropDiv = lodash_1.default.flow(react_dnd_1.DragSource(({ dockContext }) => {
    var _a;
    const dragSourceSpec = (_a = dockContext.getDefaultDndSpec()) === null || _a === void 0 ? void 0 : _a.dragSourceSpec;
    return (dragSourceSpec === null || dragSourceSpec === void 0 ? void 0 : dragSourceSpec.itemType) ? dragSourceSpec.itemType : Constants_1.ITEM_TYPE_DEFAULT;
}, dragSpec, dragCollect), react_dnd_1.DropTarget(({ dockContext }) => {
    var _a;
    const dropTargetSpec = (_a = dockContext.getDefaultDndSpec()) === null || _a === void 0 ? void 0 : _a.dropTargetSpec;
    return (dropTargetSpec === null || dropTargetSpec === void 0 ? void 0 : dropTargetSpec.itemType) ? dropTargetSpec.itemType : Constants_1.ITEM_TYPE_DEFAULT;
