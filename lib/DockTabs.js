...
class TabCache {
    ...
    render() {
        ...
        let tab = (react_1.default.createElement(DragDropDiv_1.DragDropDiv, { getRef: this.getRef, onDragStartT: onDragStart, onDragOverT: onDragOver, onDropT: onDrop, onDragLeaveT: onDragLeave },
            ...
            title,
            closable ?
                react_1.default.createElement("div", { className: 'dock-tab-close-btn', onClick: this.onCloseClick, onKeyDown: this.onKeyDownCloseBtn })
                : null));
    ...
    constructor() {
        ...
        this.renderTabBar = (props, TabNavList) => {
            ...
            if (panelExtra) {
                ...
                panelExtraContent = react_1.default.createElement("div", { className: 'dock-panel-max-btn', onClick: maximizable ? this.onMaximizeClick : null, onKeyDown: maximizable ? this.onKeyDownMaximizeBtn : null });
