...
export class TabCache {
    ...
    render() {
        ...
        return (React.createElement(DockTabPane, { key: id, id: id, cached: cached, tab: React.createElement("div", { ref: this.getRef, draggable: !tabLocked, onDrag: this.onDragStart, onDragOver: this.onDragOver, onDrop: this.onDrop, onDragLeave: this.onDragLeave },
...
export class DockTabs extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Tabs, { prefixCls: 'dock-tabs', destroyInactiveTabPane: cache === false, renderTabBar: this.renderTabBar, renderTabContent: this.renderTabContent, activeKey: activeId, onChange: this.onTabChange }, children));
    }
}
