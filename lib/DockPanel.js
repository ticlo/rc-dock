        ...
        return (react_1.default.createElement(DragDropDiv_1.DragDropDiv, { getRef: this.getRef, className: cls, style: style, "data-dockid": id, onMouseDownCapture: pointerDownCallback, onTouchStartCapture: pointerDownCallback, onDragOverT: isFloat ? null : this.onDragOver, onClick: this.onPanelClicked },
            ...
            isFloat ?
                [
                    ...
                    react_1.default.createElement("div", { key: 'DragEdgeR', style: {
                            background: 'pink',
                            opacity: 0,
                            right: -3.5,
                            height: '100%',
                            ...
                            zIndex: 299,
                            userSelect: 'none',
                        }, draggable: true, onDragStart: this.onPanelEdgeStartDragR, onDrag: this.onPanelEdgeDragMove, onDragEnd: this.onPanelEdgeDragEnd, onMouseUp: this.onPanelEdgeDragEnd }),
                    react_1.default.createElement("div", { key: 'DragEdgeB', style: {
                            background: 'pink',
                            opacity: 0,
                            bottom: -3.5,
                            width: '100%',
                            ...
                            zIndex: 299,
                            userSelect: 'none',
                        }, draggable: true, onDragStart: this.onPanelEdgeStartDragB, onDrag: this.onPanelEdgeDragMove, onDragEnd: this.onPanelEdgeDragEnd, onMouseUp: this.onPanelEdgeDragEnd }),
                    react_1.default.createElement("div", { key: 'DragEdgeL', style: {
                            background: 'pink',
                            opacity: 0,
                            left: -3.5,
                            height: '100%',
                            ...
                            zIndex: 299,
                            userSelect: 'none',
                        }, draggable: true, onDragStart: this.onPanelEdgeStartDragL, onDrag: this.onPanelEdgeDragMove, onDragEnd: this.onPanelEdgeDragEnd, onMouseUp: this.onPanelEdgeDragEnd }),
                    react_1.default.createElement("div", { key: 'DragEdgeT', style: {
                            background: 'pink',
                            opacity: 0,
                            top: -3.5,
                            width: '100%',
                            ...
                            zIndex: 299,
                            userSelect: 'none',
                        }, draggable: true, onDragStart: this.onPanelEdgeStartDragT, onDrag: this.onPanelEdgeDragMove, onDragEnd: this.onPanelEdgeDragEnd, onMouseUp: this.onPanelEdgeDragEnd })
                ]
                : null,
            droppingLayer));
    }
