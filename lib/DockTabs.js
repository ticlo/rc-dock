...
class TabCache {
    constructor(context) {
        ...
        this.onDragStart = (e) => {
            DragManager_1.DragManager.dragStart(DockData_1.DockContextType, { tab: this.data }, e.nativeEvent, this._hitAreaRef);
            e.stopPropagation();
        };
        this.onDragOver = (e) => {
    ...
    render() {
        ...
        let tab = (react_1.default.createElement("div", { ref: this.getRef },
            title,
            react_1.default.createElement("div", { className: 'dock-tab-hit-area', ref: this.getHitAreaRef, draggable: !tabLocked, onDragStart: this.onDragStart, onDragOver: this.onDragOver, onDrop: this.onDrop, onDragLeave: this.onDragLeave }, closable ?
...
class DockTabs extends react_1.default.Component {
    constructor(props, context) {
        ...
        this.renderTabBar = () => {
            ...
            return (react_1.default.createElement(DockTabBar_1.DockTabBar, { extraContent: panelExtraContent, onDragMoveInit: this.props.onPanelHeaderDragInit, onHtmlDrag: this.props.onPanelHeaderHtmlDrag }));
        };
