...
class DockTabBarRootNode extends react_1.default.PureComponent {
    render() {
        ...
        return (react_1.default.createElement(DragDropDiv_1.DragDropDiv, { onDragStartT: onDragStart, onDragMoveT: onDragMove, role: "tablist", className: 'dock-bar', tabIndex: 0, ref: this.props.saveRef('root'), onKeyDown: onKeyDown, style: style }, newChildren));
    }
}
