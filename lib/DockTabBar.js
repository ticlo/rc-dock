...
class DockTabBarRootNode extends react_1.default.PureComponent {
    render() {
        const _a = this.props, { onKeyDown, extraContent, style, children } = _a, restProps = __rest(_a, ["onKeyDown", "extraContent", "style", "children"]);
        ...
        return (react_1.default.createElement(DragInitiator_1.DragInitiator, { role: "tablist", className: 'dock-tabs-bar', tabIndex: 0, ref: this.props.saveRef('root'), onKeyDown: onKeyDown, style: style }, newChildren));
    }
}
exports.DockTabBarRootNode = DockTabBarRootNode;
class DockTabBar extends react_1.default.PureComponent {
    render() {
        const _a = this.props, { children: renderTabBarNode } = _a, restProps = __rest(_a, ["children"]);
        return (react_1.default.createElement(SaveRef_1.default, null, (saveRef, getRef) => (react_1.default.createElement(DockTabBarRootNode, Object.assign({ saveRef: saveRef }, restProps),
