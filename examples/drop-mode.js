...
},{"./bundle-url":"CSru"}],"MJWi":[function(require,module,exports) {
require("_bundle_loader")(require.resolve('./shared-import')).then(({
  ...
  let dropModeTab = {
    title: 'Drop Mode',
    content: /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "When you set ", /*#__PURE__*/React.createElement("b", null, "dropMode"), "='edge' on <DockLayout>"), /*#__PURE__*/React.createElement("p", null, "The distance between mouse cursor and panel border is used to pick drop location."))
  };
  let tab = {
    title: 'Tab',
