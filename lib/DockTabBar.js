...
export class DockTabBarRootNode extends React.PureComponent {
    render() {
        ...
        return (React.createElement(DragInitiator, { onDragInit: onDragMoveInit, onDrag: onHtmlDrag, draggable: onHtmlDrag != null, role: "tablist", className: 'dock-bar', tabIndex: 0, ref: this.props.saveRef('root'), onKeyDown: onKeyDown, style: style }, newChildren));
    }
}
