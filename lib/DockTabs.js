        ...
        this.renderTabBar = (props, TabNavList) => {
            ...
            if (panelExtra) {
                ...
                if (maximizable || showNewWindowButton) {
                    panelExtraContent = react_1.default.createElement("div", { className: panelData.parent.mode === 'maximize' ? "dock-panel-min-btn" : "dock-panel-max-btn", onClick: maximizable ? this.onMaximizeClick : null });
