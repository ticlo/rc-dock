...
class DockTabs extends react_1.default.Component {
    constructor(props, context) {
        ...
        this.renderTabBar = () => {
            ...
            return (react_1.default.createElement(DockTabBar_1.DockTabBar, { extraContent: panelExtraContent, onDragStart: this.props.onPanelDragStart, onDragMove: this.props.onPanelDragMove }));
        };
