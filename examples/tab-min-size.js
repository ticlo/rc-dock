...
},{"./bundle-url":"CSru"}],"b9ig":[function(require,module,exports) {
require("_bundle_loader")(require.resolve('./shared-import')).then(({
  ...
  function getTab(width, height) {
    ...
    return {
      ...
      minWidth: width,
      minHeight: height,
      content: /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "This tab has a minimal size.", /*#__PURE__*/React.createElement("br", null), width, " x ", height, " px"))
    };
  }
