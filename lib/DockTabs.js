...
class TabCache {
    ...
    render() {
        ...
        let tab = (react_1.default.createElement(DragDropDiv_1.DragDropDiv, { getRef: this.getRef, onDragStartT: onDragStart, role: "tab", "aria-selected": parent.activeId === id, onDragOverT: onDragOver, onDropT: onDrop, onDragLeaveT: onDragLeave, tabData: this.data },
            react_1.default.createElement("div", { className: "dock-tab-title" }, title),
            closable ?
...
class DockTabs extends react_1.default.PureComponent {
    constructor() {
        ...
        this.onCollapseExpandClick = (e) => {
            ...
            this.context.updatePanelData(panelData.id, Object.assign(Object.assign({}, panelData), { collapsed: !(panelData === null || panelData === void 0 ? void 0 : panelData.collapsed) }), 'collapse');
        ...
        this.renderTabBar = (props, TabNavList) => {
            ...
            if (maximizable || showNewWindowButton) {
                panelDefaultContent = react_1.default.createElement("div", { className: panelData.parent.mode === 'maximize' ? "dock-panel-min-btn" : "dock-panel-max-btn", onClick: maximizable ? this.onMaximizeClick : null });
            ...
            const renderCollapseExpandBtn = () => {
                if (panelData.collapsed) {
                    return (react_1.default.createElement("div", { className: 'dock-panel-expand-btn', onClick: this.onCollapseExpandClick }));
                }
                ...
                return (react_1.default.createElement("div", { className: 'dock-panel-collapse-btn', onClick: this.onCollapseExpandClick }));
            };
    ...
    render() {
        ...
        return (react_1.default.createElement(rc_tabs_1.default, { prefixCls: classnames_1.default(this.context.getClassName(), "dock"), moreIcon: "...", animated: animated, renderTabBar: this.renderTabBar, activeKey: activeId, tabPosition: tabPosition, onChange: this.onTabChange }, children));
    }
}
