...
const EnhancedDndDragDropDiv = lodash_1.default.flow(react_dnd_1.DragSource(Constants_1.ITEM_TYPE_COMPONENT, dragSpec, dragCollect), react_dnd_1.DropTarget(Constants_1.ITEM_TYPE_COMPONENT, dropSpec, dropCollect))(DndDragDropDiv);
