...
class DockDropLayer extends react_1.default.PureComponent {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", { className: classnames_1.default("dock-drop-layer", this.context.getClassName()), style: styles[panelData.tabPosition] }, children));
    }
}
