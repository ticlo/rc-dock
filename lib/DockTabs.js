...
const tabs_1 = __importDefault(require("@rc-component/tabs"));
const menu_1 = __importStar(require("@rc-component/menu"));
const dropdown_1 = __importDefault(require("@rc-component/dropdown"));
...
class DockTabs extends React.PureComponent {
    ...
    addNewWindowMenu(element, showWithLeftClick) {
        const nativeMenu = (React.createElement(menu_1.default, { prefixCls: "dock-dropdown-menu", onClick: this.onNewWindowClick },
            React.createElement(menu_1.MenuItem, { key: 'new-window' }, "New Window")));
        let trigger = showWithLeftClick ? ['contextMenu', 'click'] : ['contextMenu'];
        return (React.createElement(dropdown_1.default, { prefixCls: "dock-dropdown", overlay: nativeMenu, trigger: trigger, mouseEnterDelay: 0.1, mouseLeaveDelay: 0.1 }, element));
    }
    render() {
        ...
        for (let [id, tabCache] of this._cache) {
            ...
            items.push({
                ...
                children: (React.createElement(DockTabPane_1.default, { cacheId: id, cached: tabCache.cached, active: isActive, animated: animated, prefixCls: "dock" }, tabCache.tabContent)),
                forceRender: tabCache.cached !== false,
                closable: tabCache.data.closable,
                disabled: false,
            });
        }
        return (React.createElement(tabs_1.default, { prefixCls: "dock", more: { icon: moreIcon }, animated: animated, renderTabBar: this.renderTabBar, activeKey: activeId, onChange: this.onTabChange, popupClassName: (0, classnames_1.default)((0, Utils_1.groupClassNames)(group)), items: items }));
    }
}
