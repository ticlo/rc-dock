...
},{"./bundle-url":"FheM"}],"XbEN":[function(require,module,exports) {
...
require("_bundle_loader")(require.resolve('./shared-import')).then(({
  ...
  class Demo extends React.Component {
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement("div", null, "Divider can be used separately, this doesn't require anything else from the dock layout package", /*#__PURE__*/React.createElement("div", {
        ref: this.getRef,
        className: "box"
