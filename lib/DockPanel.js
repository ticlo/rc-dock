...
class DockPanel extends react_1.default.PureComponent {
    constructor() {
        ...
        this.onPanelHeaderHtmlDrag = (event) => {
            DragManager_1.DragManager.dragStart(DockData_1.DockContextType, { panel: this.props.panelData }, event.nativeEvent, this._ref);
    ...
    render() {
        ...
        return (react_1.default.createElement("div", { ref: this.getRef, className: cls, style: style, "data-dockid": id, onPointerDown: pointerDownCallback, onDragEnter: isFloat ? null : this.onDragEnter },
            ...
            isFloat ?
                [
                    react_1.default.createElement(DragDropDiv_1.DragDropDiv, { key: 'drag-size-t-l', className: 'dock-panel-drag-size dock-panel-drag-size-t-l', onDragInit: this.onPanelCornerDragTL }),
                    react_1.default.createElement(DragDropDiv_1.DragDropDiv, { key: 'drag-size-t-r', className: 'dock-panel-drag-size dock-panel-drag-size-t-r', onDragInit: this.onPanelCornerDragTR }),
                    react_1.default.createElement(DragDropDiv_1.DragDropDiv, { key: 'drag-size-b-l', className: 'dock-panel-drag-size dock-panel-drag-size-b-l', onDragInit: this.onPanelCornerDragBL }),
                    react_1.default.createElement(DragDropDiv_1.DragDropDiv, { key: 'drag-size-b-r', className: 'dock-panel-drag-size dock-panel-drag-size-b-r', onDragInit: this.onPanelCornerDragBR })
                ]
                : null,
            droppingLayer));
    }
