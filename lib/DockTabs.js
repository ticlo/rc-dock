...
class TabCache {
    ...
    render() {
        ...
        return (react_1.default.createElement(rc_tabs_1.TabPane, { key: id, tab: react_1.default.createElement("div", { ref: this.getRef, draggable: !tabLocked, onDrag: this.onDragStart, onDragOver: this.onDragOver, onDrop: this.onDrop, onDragLeave: this.onDragLeave },
                title,
                closable ?
