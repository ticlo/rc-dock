...
function maximizePanel(layout, panel) {
    ...
    let placeHodlerPanel = Object.assign({}, panel, { id: DockData_1.maximePlaceHolderId, tabs: [], panelLock: {} });
...
function restorePanel(layout, panel) {
    ...
    if (placeHolder) {
        ...
        panel = Object.assign({}, panel, { x, y, z, w, h });
...
function replaceBox(layout, box, newBox) {
    ...
    if (parentBox) {
        ...
        if (box.id === layout.dockbox.id || box === layout.dockbox) {
            ...
            return Object.assign({}, layout, { maxbox: newBox });
        }
    }
    return layout;
}
